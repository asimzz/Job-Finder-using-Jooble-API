  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      authFailureOrSuccess: authFailureOrSuccess == freezed
          ...
          : authFailureOrSuccess as Option<Either<AuthFailure, User>>,
    ));
  }
}
...
class _$_SignUpState with DiagnosticableTreeMixin implements _SignUpState {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'SignUpState(username: $username, emailAddress: $emailAddress, password: $password, showErrorMessages: $showErrorMessages, isSubmitting: $isSubmitting, authFailureOrSuccess: $authFailureOrSuccess)';
  }
