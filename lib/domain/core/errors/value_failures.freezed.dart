...
class _$ValueFailureTearOff {
  ...
  InvalidSalary<T> invalidSalary<T>({@required T failedValue}) {
    return InvalidSalary<T>(
      failedValue: failedValue,
    );
  }
}
...
mixin _$ValueFailure<T> {
  ...
  Result when<Result extends Object>({
    ...
    @required Result invalidSalary(T failedValue),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    ...
    Result invalidSalary(T failedValue),
  ...
  Result map<Result extends Object>({
    ...
    @required Result invalidSalary(InvalidSalary<T> value),
  });
  @optionalTypeArgs
  Result maybeMap<Result extends Object>({
    ...
    Result invalidSalary(InvalidSalary<T> value),
    @required Result orElse(),
  });
...
abstract class $InvalidSalaryCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
  factory $InvalidSalaryCopyWith(
          InvalidSalary<T> value, $Res Function(InvalidSalary<T>) then) =
      _$InvalidSalaryCopyWithImpl<T, $Res>;
  @override
  $Res call({T failedValue});
}

class _$InvalidSalaryCopyWithImpl<T, $Res>
    extends _$ValueFailureCopyWithImpl<T, $Res>
    implements $InvalidSalaryCopyWith<T, $Res> {
  _$InvalidSalaryCopyWithImpl(
      InvalidSalary<T> _value, $Res Function(InvalidSalary<T>) _then)
      : super(_value, (v) => _then(v as InvalidSalary<T>));

  @override
  InvalidSalary<T> get _value => super._value as InvalidSalary<T>;

  @override
  $Res call({
    Object failedValue = freezed,
  }) {
    return _then(InvalidSalary<T>(
      failedValue:
          failedValue == freezed ? _value.failedValue : failedValue as T,
    ));
  }
...
class _$InvalidSalary<T>
    with DiagnosticableTreeMixin
    implements InvalidSalary<T> {
  const _$InvalidSalary({@required this.failedValue})
      : assert(failedValue != null);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ValueFailure<$T>.invalidSalary(failedValue: $failedValue)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ValueFailure<$T>.invalidSalary'))
      ..add(DiagnosticsProperty('failedValue', failedValue));
  }
  ...
  @override
  $InvalidSalaryCopyWith<T, InvalidSalary<T>> get copyWith =>
      _$InvalidSalaryCopyWithImpl<T, InvalidSalary<T>>(this, _$identity);
  ...
  Result when<Result extends Object>({
    ...
    assert(invalidLocation != null);
    assert(invalidSalary != null);
    return invalidSalary(failedValue);
  }
...
abstract class InvalidSalary<T> implements ValueFailure<T> {
  const factory InvalidSalary({@required T failedValue}) = _$InvalidSalary<T>;
